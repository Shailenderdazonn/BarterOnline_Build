...
// FROM user_ads LEFT JOIN user_detail ON user_ads.userid= user_detail.ID LIMIT 3 ";

$sql = "SELECT user_ads.id,user_ads.title,user_ads.category,user_ads.location,user_ads.price,user_ads.description,user_ads.file,user_detail.name,user_detail.mobile 
FROM user_ads 
LEFT JOIN user_detail ON user_ads.userid= user_detail.ID 
ORDER BY user_ads.id DESC  
LIMIT 3";
